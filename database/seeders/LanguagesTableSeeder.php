...
class LanguagesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Language::create([
            ...
            'is_active' => false,
            'local_code' => 'fr_fr',
            'www_link_title' => 'Titre du lien français',
        ...
        Language::create([
            ...
            'is_active' => false,
            'local_code' => 'en_en',
            'www_link_title' => 'Titre du lien anglais',
        ...
        Language::create([
            ...
            'is_active' => false,
            'local_code' => 'de_de',
            'www_link_title' => 'Titre du lien allemand',
        ...
        Language::create([
            ...
            'is_active' => false,
            'local_code' => 'nl_nl',
            'www_link_title' => 'Titre du lien néerlandais',
            'www_link_text' => 'Nederlands',
            'language_name' => 'dutch',
            'og_title' => 'titre4',
            'og_type' => 'titre4',
            'og_image' => 'titre4',
        ...
        Language::create([
            ...
            'is_active' => false,
            'local_code' => 'it_it',
            'www_link_title' => 'Titre du lien italien',
        ...
        Language::create([
            ...
            'is_active' => false,
            'local_code' => 'es_es',
            'www_link_title' => 'Titre du lien espagnol',
        ...
        Language::create([
            ...
            'is_active' => false,
            'local_code' => 'pt_pt',
            'www_link_title' => 'Titre du lien portugais',
